...
<div class="content">
  <div class="content__container">
    <div class="content__left">
      ...
      <div class="content__main">
        ...
        <div class="content__main-title">
          <a href="./news-humburger.php">Tặng 1 chiếc Humberger miễn phí cho ngày sinh nhật của bạn</a>
          <br />
          <i>30/12/2021</i> <br />
          <p>
            Tặng 1 chiếc Humberger miễn phí cho ngày sinh nhật của bạn.
            Tặng...
          </p>
        </div>
      </div>
      <div class="content__main">
        ...
        <div class="content__main-title">
          <a href="./news-khuyen-mai-246.php">Khuyến mại thứ 2, thứ 4, thứ 6 hàng tuần khi mua 2 combo Đùi gà
            chiên</a>
          <br />
          <i>30/12/2021</i><br />
          <p>
            Mua 2 combo Đùi gà chiên. Áp dụng vào các ngày trong tuần như...
          </p>
        </div>
      </div>
      <div class="content__main">
        ...
        <div class="content__main-title">
          <a href="./news-khuyen-mai-35.php">Khuyến mại thứ 3, thứ 5 hàng tuần</a> <br />
          <i>30/12/2021</i><br />
          <p>Mua 2 suất Cánh gà chiên mắm. Tặng...</p>
        </div>
      </div>
      <div class="content__main">
        <div class="content__main-img">
        ...
        <div class="content__main-title">
          <a href="./news-khuyen-mai-nuoc.php">Tặng 1 Nước chanh leo vào chủ nhật</a> <br />
          <i>30/12/2021</i> <br />
          <p>Tặng 1 Nước chanh leo vào chủ nhật khi mua 2 suất...</p>
        </div>
      </div>
      <div class="content__main-bottom">
        <div class="content__main-img">
          <img src="./img/main-humberger.jpg" alt="" />
        </div>
        <div class="content__main-title">
    ...
    <div class="content__right">
      <div class="content__right-heading">
        <div class="content__right-heading-title">
          <span>TIN TỨC</span>
          <i class="fa fa-align-right"></i>
        </div>
        <div class="content__right-heading-bottom">
          <div class="content__right-heading-main khuyen">
            <a href="./promotion.php">Tin khuyến mại</a>
          </div>
          <div class="content__right-heading-main">
            <a href="./store.php">Tin ẩm thực</a>
          </div>
        </div>
      </div>

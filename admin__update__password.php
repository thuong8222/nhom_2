        ...
        <form action="admin__update__password.php" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" name="confirm_password" id="" placeholder="Current Password" required>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
...
<?php 
    ...
    if (isset($_POST['submit'])){
        ...
        $sql = "SELECT * FROM `ad` WHERE id='$id' AND password='$current_password'";
        $res=mysqli_query($con,$sql);
        $count = mysqli_num_rows($res);
        if($count >0){if(isset($res)){
                // echo "hi";
